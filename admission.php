    ...
    <form method="post" action="kahon.php">
      <fieldset data-role="collapsible">
        <legend>Admission</legend>
          ...
          <input type="date" name="SOC" id="SOC"  oninput="calculatedate()" onkeydown="return addSlashes(this)" maxlength="10" placeholder="mm/dd/yyyy" onkeypress="return isDateKey(event)" required autofocus data-clear-btn="true">
<img src="/image/calendar_icon.jpg" alt="calendar" onclick="ds_sh(SOC)">
...
//var SOC = document.getElementById("SOC").value=document.getElementById("episode_start").value;
//var SOCmo=SOC.getUTCMonth()+1;
//var SOCdd=SOC.getUTCDate();
//var SOCyy=SOC.getUTCFullYear();
//document.getElementById("SOC").value=SOCyy+"/"+SOCmo+"/"+SOCdd;
...
function getAge(birth) {
  ...
  <!--
   ...
   <SCRIPT language=Javascript>
      ...
      {
         var xcharCode = event.which || event.keyCode || event.charCode; 
         if (xcharCode > 31 && xcharCode != 45 && (xcharCode < 48 || xcharCode > 57))
            return false;
else
         return true;
      }
