...
<?php
include 'config.php';
$ClientID = $_SESSION["initclientID"];
...
$sql = "INSERT INTO Client (ClientID, FirstName, MI, LastName, Suffix, DOB, FullName, ClientSSN, MedicareNum, Gender, comments)
 VALUES ('$ClientID', '$FirstName', '$MI', '$LastName', '$Suffix', '$DOB', '$FullName', '$ClientSSN', '$MedicareNum', '$Gender', '$comments')";
...
<div class="form-group">
   ...
   <input type="text" class="form-control" id="FirstName" onkeypress="return isletterKey(event)" onkeyup="myFunctiontoUpperCasev()" name="FirstName" required autofocus>
   <span class="error">* <?php echo $FirstNameErr;?></span>
</div>

<div class="form-group">
   <labelfor="MI">MI:</label>
...
<div class="form-group">
   ...
   <input type="text" class="form-control" id="LastName" onkeypress="return isAlphaKey(event)" onkeyup="myFunctiontoUpperCaseu()" name="LastName" maxlength="30" placeholder="Last Name" value="<?php echo $LastName;?>" required autofocus>
...
<div class="form-group">
   ...
   <input type="date" class="form-control" id="DOB" name="DOB" placeholder="mm/dd/yyyy" onkeypress="return isDateKey(event)" onkeyup="myAgeValidation()" onkeydown="return addSlashes(this)" maxlength="10" required value="<?php echo $DOB;?>" autofocus>
   <br>
...
<tr><td id="ds_calclass">
   ...
   <input type="number" Class="form-control" id="edad" name="age" value="<?php echo $age;?>" autofocus disabled>
...
<div class="form-group">
   ...
   <input type="text" class="form-control" id="ClientSSN" onkeypress="return isNumberKey(event)" onkeydown="return adddashes(this)" name="ClientSSN" maxlength="11" placeholder="999-99-9999" required value="<?php echo $ClientSSN;?>" autofocus> 
   <span class="error">* <?php echo $ClientSSNErr;?></span>
</div>

<div class="form-group">
   <label for="MedicareNum">Medicare Number:</label>
   <input type="text" class="form-control" id="MedicareNum" onkeypress="return isAlphaNumericKey(event)" name="MedicareNum" placeholder="Medicare Number" onkeyup="myFunctiontoUpperCaseMedicareNum()" autofocus>
</div>

<div class="form-group">
   <label for="MedicaidNum">Medicaid Number:</label>
   <input type="text" class="form=control" id="medicaidNum" placeholder="Medicaid Number" name="MedicaidNum" autofocus>
</div>   
...
<div class="form-group">
   ...
   <textarea name="comments" rows="5" cols="40"  maxlength=255></textarea>
</div>
