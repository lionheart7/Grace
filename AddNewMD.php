...
<div class="form-group">
   ...
   <input type="date" class="form-control" id="DOB"  onkeypress="return isDateKey(event)"  onkeydown="return addSlashes(this)" name="DOB" maxlength="10" placeholder="mm/dd/yyyy" required value="<?php echo $DOB = date_format($DOB,"m/d/Y");?>" style="cursor: text" onkeyup="myAgeValidation()" autofocus/>
   <br>
   
   <img src="/image/calendar_icon.jpg" alt="calendar" onclick="ds_sh(DOB)" onkeyup="myAgeValidation()">
...
<tr><td id="ds_calclass">
   ...
   <input type="text" Class="form-control" id="edad" name="age" value="<?php echo $age;?>" autofocus>
    
   <br>
   Field1: <input type="text" id="field1" value="<?php echo $age;?>"><br>
...
function getAge(birth) {
    ...
    document.getElementById("field1").value = document.getElementById("edad").value;
}
...
function myFunction() {
    ...
    document.getElementById("field3").value = document.getElementById("field2").value;
